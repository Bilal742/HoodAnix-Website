...
const AuthPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (isLogin) {
            // Login logic - for now just show message
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        required={!isLogin}
                                        className="w-full pl-10 pr-4 py-2 rounded bg-white/10 border border-white/20 focus:outline-none focus:ring-2 focus:ring-green-500"
